					...
					foreach($statement->fetchAll() as $row)
					{
						...
						<tr>
							...
							<td>
								...
								<button type="button" name="delete_button" class="btn btn-warning btn-sm" onclick="delete_data(`'.$row["author_id"].'`, `'.$row["author_status"].'`)">'.$author_status_btn.'</button>

								<button name="dlt-btn" class="btn btn-danger btn-sm dlt-btn"  onclick="delete_cat(`'.$row["author_id"].'`);">Delete</button>
							</td>
						</tr>
						';
					}
...
<!-- delete  -->
<form action="deleteauthor.php" method="post" id="dltForm">
