...
if(isset($_GET['search_text'])){
    ...
    $query = "
	SELECT * FROM lms_issue_book WHERE user_id = '$searchText'
...
<div class="search-box">
		<form action="issubooksearch.php" method="get" class="row">
			<div class="col-lg-8">
			<input type="text" name="search_text" class="form-control my-2" placeholder="Search By User Id....">
			</div>
			<div class="col-lg-3">
