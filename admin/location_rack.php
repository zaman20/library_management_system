...
<div class="container-fluid py-4" style="min-height: 700px;">
					...
					foreach($statement->fetchAll() as $row)
					{
						...
						<tr>
							...
							<td>
								...
								<button type="button" name="delete_button" class="btn btn-danger btn-sm" onclick="delete_cat(`'.$row["location_rack_id"].'`)">Delete</button>
							</td>
						</tr>
						';
	...
	<!-- delete  -->
	<form action="deleterack.php" method="post" id="dltForm">
