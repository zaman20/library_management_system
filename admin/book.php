...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	<div class="search-box">
		<form action="booksearch.php" method="get" class="row">
			<div class="col-lg-8">
        			...
        			foreach($statement->fetchAll() as $row)
        			{
        				...
        				<tr>
        					...
        					<td>
        						...
        						<button type="button" name="delete_button" class="btn btn-warning btn-sm" onclick="delete_data(`'.$row["book_id"].'`, `'.$row["book_status"].'`)">'.$book_status_btn.'</button>
        						<button type="button" name="delete_button" class="btn btn-danger btn-sm" onclick="delete_cat(`'.$row["book_id"].'`)">Delete</button>
        					</td>
        				</tr>
        				';
        			}
...
<!-- delete  -->
<form action="deletebook.php" method="post" id="dltForm">
		<input type="hidden" name="p_id" id="catId">
	</form>
<!-- ------ -->
<?php include('dlt.php');?>
